...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20230319_miprimersitioweb_361fb44a9701ddce2969_20230319205111_archive.zip';
        const ARCHIVE_SIZE       = '56594335';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '361fb44-19205111';
        const SECONDARY_PACKAGE_HASH = '099b11a-19205111';
        const VERSION            = '1.5.3';
